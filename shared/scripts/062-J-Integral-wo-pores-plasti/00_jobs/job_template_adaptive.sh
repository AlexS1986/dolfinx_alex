...
#SBATCH -e /work/scratch/as12vapa/062-J-Integral-wo-pores-plasti/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/062-J-Integral-wo-pores-plasti/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/062-J-Integral-wo-pores-plasti/$working_folder_name"
