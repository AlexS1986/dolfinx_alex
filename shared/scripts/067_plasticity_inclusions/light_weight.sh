...
SOURCE_DIR="${SOURCE_DIR:-/work/scratch/as12vapa/067_plasticity_inclusions_03_06_2026}"
TARGET_DIR="${TARGET_DIR:-/work/scratch/as12vapa/067_plasticity_inclusions_lightweight_03_06_2026}"
