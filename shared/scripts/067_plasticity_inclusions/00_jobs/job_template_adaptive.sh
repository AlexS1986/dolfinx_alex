...
#SBATCH -N 1
#SBATCH -e /work/scratch/as12vapa/067_plasticity_inclusions/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/067_plasticity_inclusions/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/067_plasticity_inclusions/$working_folder_name"
...
srun -n 1 apptainer exec --bind $HOME/dolfinx_alex/shared:/home,$working_directory:/work $HOME/dolfinx_alex/alex-dolfinx.sif python3 $working_directory/run_effective_stiffness.py --lam_matrix_param "$LAM_MATRIX_PARAM" --mue_matrix_param "$MUE_MATRIX_PARAM" --lam_inclusion_param "$LAM_INCLUSION_PARAM" --mue_inclusion_param "$MUE_INCLUSION_PARAM"
