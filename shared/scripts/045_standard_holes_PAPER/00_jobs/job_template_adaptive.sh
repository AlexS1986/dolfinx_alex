...
#SBATCH -e /work/scratch/as12vapa/045_standard_holes_PAPER/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/045_standard_holes_PAPER/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/045_standard_holes_PAPER/$working_folder_name"
