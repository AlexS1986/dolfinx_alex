...
postprocessing_interval = dlfx.fem.Constant(domain,200.0)
...
# Define simulation parameters to write
parameters_to_write = {
    'mesh_file': mesh_file,
...
# Function to create a unique timestamped directory
...
# Function to copy files into the directory
...
# Only rank 0 handles file writing and copying
if rank == 0:
    # Append simulation parameters to the parameter file
