...
JOB_SCRIPT_NAME="job_script_260504.sh"
DRY_RUN=0
MAX_SUBMISSIONS=""
...
if [ ! -d "$BASE_DIR" ]; then
    ...
    echo "Run 01_create_directories_for_260504_sweep.sh, 02_create_jobsa_260504_sweep.sh, and 03_create_jobsb_260504_sweep.sh first."
    exit 1
fi
