...
#SBATCH -e /work/scratch/as12vapa/060_plasti-wo-pores/{FOLDER_NAME}/%x.err.%j
#SBATCH -o /work/scratch/as12vapa/060_plasti-wo-pores/{FOLDER_NAME}/%x.out.%j
...
working_directory="$HPC_SCRATCH/060_plasti-wo-pores/$working_folder_name"
