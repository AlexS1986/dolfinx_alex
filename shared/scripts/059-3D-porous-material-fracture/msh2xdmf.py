...
input_file_path = os.path.join(alex.os.resources_directory, "ronny_3D_porous","sim_matrix_inclusion_pf_3D_unit_N20_RO_b0.05_vol_dev_incremental_mesh.msh")
outputfile_xdmf_path = os.path.join(script_path,"output.xdmf")
...
active_cells = [cell for index, cell in enumerate(cells) if (cells_id[index]) == 0]
