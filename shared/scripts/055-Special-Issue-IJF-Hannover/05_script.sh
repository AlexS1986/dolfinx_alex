...
mpirun -np 4 python3 01_phasefield_mbb_whole_folder_staggered.py "$FOLDER" "vary" 20 20

# # Run the mesh conversion script
# Run the phasefield script in parallel with 4 processes
# mpirun -np 4 python3 01_phasefield_mbb_whole_folder_staggered.py "$FOLDER" "fromfile" 1 20 
