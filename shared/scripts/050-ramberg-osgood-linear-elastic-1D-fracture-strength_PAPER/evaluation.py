...
# NEW: reduced stiffness dataset (mu = 0.25)
path_gc_mu025 = os.path.join(script_path, 'run_simulation_linear_elastic_graphs_mu0.25.txt')
data_linear_elastic_gc_mu025 = pd.read_csv(
    path_gc_mu025, delim_whitespace=True, header=None, skiprows=1
)

# NEW: plasticity dataset
...
ev.plot_multiple_columns(
    [
        ...
        data_linear_elastic_gc_scaled_2,
